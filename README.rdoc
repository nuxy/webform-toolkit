...
- Fast and lightweight (jQuery plug-in *only 6.5 kB)
...
Download the latest {sources}[https://github.com/nuxy/Webform-Toolkit/tags] and refer to the {README}[https://labs.mbrooks.info/demos/Webform-Toolkit/README.html] for more information about this package.
